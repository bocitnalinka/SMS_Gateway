...
class OneConnection {
    ...
    void getRequest() throws Exception {
        ...
        try {
            ...
            if (op_val<1){
               System.out.println("Err Invalid Mobile number " + phone); 
               LogFile.info("      Err Invalid Mobile number " + phone);
            }
            else {
            ...
            LogFile.info(" --------> ");
            LogFile.info(" Err   Error Phone Number, pipe at "+pipe_at + " Org msg is=>" + line);
            LogFile.info("       Exception is " + ex);
            System.out.println(" Err   Error, Phone Number with Alpha, pipe at "+pipe_at + phone);
...
public class New_CRC_Svr {
    ...
    private static int crc_port = 2051;   // 3051;  
